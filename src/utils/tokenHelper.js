 ...
 */
function generateWebToken(userData, pinExpiryMinutes = 3, sessionExpiryHours = 2) {
  ...
  // 1. Tạo mã PIN 6 số ngẫu nhiên mới (hiệu lực 3 phút)
  ...
  // Lưu PIN vào store (3 phút), Token lưu để HMAC fallback verify không cần store
