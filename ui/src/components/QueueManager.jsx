...
import { ListOrdered, Trash2, Music2 } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between bg-anna-surface px-4 py-2.5 rounded-xl border border-anna-border">
        <div className="flex items-center gap-2">
          <ListOrdered className="w-4 h-4 text-anna-accent" />
        ...
        {songs.length > 0 && (
          <button
            ...
            className="text-xs text-anna-red hover:underline font-semibold flex items-center gap-1"
          >
            ...
            {songs.map((song, idx) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg text-anna-muted hover:text-anna-red hover:bg-anna-red/10 transition opacity-0 group-hover:opacity-100"
